...
public class GameLostScreen extends MenuScreen {
	...
	private Texture mLostScreenTexture;
	...
	public void loadGLContent(ResourceManager pResourceManager) {
		...
		mLostScreenTexture = pResourceManager.textureManager().loadTexture("TEXTURE_SCREENLOST", "res/textures/textureLostScreen.png", entityGroupID());
